    ...
    <>
      {loading ? (
        ...
        <div className='overflow-hidden'>
          <m.div initial={{ y: "100%" }} animate={{ y: "0%" }} transition={{ duration: 0.75, ease: "easeIn" }} exit={{ opacity: 1 }} className='overflow-hidden box-border'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='my-16  flex justify-center'>
                <button
                  className='w-40 p-2 mx-2 rounded-2xl  shadow-slate-400 shadow-sm border-2 border-slate-300 text-white bg-lime-700 hover:bg-lime-600 hover:border-slate-400 text-xl'
